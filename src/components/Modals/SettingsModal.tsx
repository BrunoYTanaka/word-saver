...
const SettingsModal = () => {
  ...
  }, [showSettingsModal, words, contexts, alerts])
      ...
      >
        <div className="space-y-6">
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <div className="text-sm text-red-700 dark:text-red-300">
                    Remove permanentemente todas as palavras, contextos, alertas
                    e configurações. Esta ação não pode ser desfeita!
                  </div>
                </div>
                <Button
                  variant="outline"
          ...
          <div className="flex justify-end border-t border-gray-200 pt-4 dark:border-gray-700">
            <Button onClick={toggleSettingsModal}>Fechar</Button>
          </div>
        </div>
      </Modal>

      {/* Export/Import Modals */}
      {showExportModal && <ExportDataModal />}
